...
grad(th0,t=t80,y=y)
hess(th0,t=t80,y=y)
Hessian(th0,y=y,t=t80,grad = grad,eps =1e-8 )
chol(hess(th0,t=t80,y=y))
...
newt(theta= th0,func,grad,hess,t=t80,y=y,tol=1e-8,fscale=1,maxit=100,max.half=20,eps=1e-6)


#finite difference
Hessian <- function(theta, y,func t=t80,grad,eps){
